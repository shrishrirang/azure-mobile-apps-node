    ...
    describe('tables.path', function () {
        it("generates path objects for tables", function () {
            expect(paths(configuration)(table)).to.containSubset({
                '/tables/todoitem': {
                    get: { parameters: [ { name: "$filter" }, { name: "zumo-api-version" } ], operationId: 'GetTodoitem', responses: {} },
                ...
                '/tables/todoitem/{id}': {
                    get: { parameters: [ { name: "id" }, { name: "zumo-api-version" } ], operationId: 'QueryTodoitem', responses: {} },
