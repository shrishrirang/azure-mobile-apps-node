...
﻿var expect = require('chai').expect,
    setAccess = require('../../../src/express/script/setAccess'),
    definition;

describe('azure-mobile-apps.express.script.access', function() {
    ...
    it('does not override if unrecognized access', function () {
        definition = {
            authorize: true,
            disable: true,
            method: {
