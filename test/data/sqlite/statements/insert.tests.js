...
describe('azure-mobile-apps.data.sqlite.statements', function () {
    describe('insert', function () {
        ...
        it('generates simple statement and parameters', function () {
            ...
            expect(statement.sql).to.equal('INSERT INTO [table] ([id],[p1],[p2]) VALUES (@id,@p1,@p2); SELECT * FROM [table] WHERE [id] = @id');
        ...
        it('does not specify id when table has autoIncrement specified', function () {
            ...
            expect(statement.sql).to.equal('INSERT INTO [table] ([p1]) VALUES (@p1); SELECT * FROM [table] WHERE [id] = SCOPE_IDENTITY()');
        ...
        it('inserts default values if none specified', function () {
            ...
            expect(statement.sql).to.equal('INSERT INTO [table] DEFAULT VALUES; SELECT * FROM [table] WHERE [id] = SCOPE_IDENTITY()');
