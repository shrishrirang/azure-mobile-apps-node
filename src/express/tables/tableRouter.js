...
var middlewareFactory = require('../middleware'),
...
module.exports = function (table) {
    var createMiddleware = middlewareFactory.tables(table),
        defaultRoute = '/',
        idRoute = '/:id',
    ...
    configureOperation('read', 'get', [defaultRoute], ['parseQuery'], ['nextLink']);
    configureOperation('read', 'get', [idRoute], ['parseQuery'], ['eTag']);
    configureOperation('insert', 'post', [defaultRoute], ['parseItem', 'checkReservedProperties'], ['eTag']);
    configureOperation('undelete', 'post', [idRoute], ['parseQuery'], ['eTag']);
    configureOperation('update', 'patch', [defaultRoute, idRoute], ['parseItem', 'checkReservedProperties', 'createQuery'], ['eTag']);
    configureOperation('delete', 'delete', [defaultRoute, idRoute], ['parseQuery'], ['eTag']);
    ...
    function buildOperationMiddleware(operation, pre, post) {
        ...
        if (pre) middleware.unshift.apply(middleware, pre.map(createMiddleware));
        if (post) middleware.push.apply(middleware, post.map(createMiddleware));
